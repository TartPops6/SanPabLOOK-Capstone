...
public class HotelPalmeras extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //recycler view horizontal
        recyclerViewHotelReviewsPalmeras = findViewById(R.id.recyclerViewHotelReviewsPalmeras);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        recyclerViewHotelReviewsPalmeras.setLayoutManager(layoutManager);

        FirebaseFirestore db = FirebaseFirestore.getInstance();
        db.collection("UserReview")
                .whereEqualTo("establishmentID", "palmerasHotel")
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            recyclerViewHotelReviewsPalmeras.setAdapter(adapter);
    ...
    private void goToViewAllReviews(View view) {
        Intent intent = new Intent(HotelPalmeras.this, ViewAllRatingsHotel.class);
